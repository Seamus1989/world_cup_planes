      ...
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col px-6">
        ...
        <section className="flex flex-1 flex-col justify-center py-16">
          ...
          <p className="mt-6 max-w-xl text-lg text-ink-dim">
            The Planes office sweepstake for the 2026 World Cup. Check in with
            Google, get drawn a team in the big reveal, then watch the
            tournament unfold with your flights front and centre.
          </p>
          ...
          <p className="mt-4 font-mono text-[11px] uppercase tracking-widest text-ink-dim">
            By checking in you agree to our{" "}
            <Link
              href="/privacy"
              className="text-amber underline transition hover:brightness-110"
            >
              gloriously silly privacy policy
            </Link>
            .
          </p>
        </section>
          ...
          <div className="overflow-hidden rounded-board border border-hairline bg-board">
            ...
            <ul className="divide-y divide-hairline">
              {PREVIEW_BOARD.map((row) => (
                ...
                >
                  <span className="text-sm tracking-widest text-ink-dim">
                    {row.player}
                  </span>
                  <span className="text-base tracking-[0.2em] text-ink">
                    {row.team}
                  </span>
                  <span className="flex items-center gap-4 text-sm">
                    ...
                    <span
                      className={`w-28 text-right tracking-widest ${toneClass[row.tone]}`}
                    >
                      {row.status}
                    </span>
                  </span>
